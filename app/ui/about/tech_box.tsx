...
export default function TechBox({ logo }: {logo:string}) {
    ...
    return (
        <div className="flex flex-col justify-center h-[100px] w-[120px] p-[20px] m-[8px] transition-all duration-150 bg-lightbg md:hover:bg-blue-950 border border-lightgrey rounded-lg">
